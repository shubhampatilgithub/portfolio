    ...
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 my-10 gap-5">
        {workData.map((project, index) => (
          ...
          >
            <div className="bg-white w-10/12 absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              <div>
